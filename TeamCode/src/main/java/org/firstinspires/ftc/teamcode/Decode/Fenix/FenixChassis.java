...
public class FenixChassis {
    ...
    //Construtor da classe FenixChassis.
    public FenixChassis(HardwareMap hardwareMap){
    ...
    //Construtor da função para andar.
    public void run(double drive, double turn, double strafe, double powerReduction){
